...
carto_query = carto_query + 'SELECT%20name,location_description%20FROM%20sf_civic_art_collect%20WHERE%20ST_DISTANCE(the_geom,SetSRID(ST_POINT('+str(lng)+','+str(lat)+'),4326))<0.003'
